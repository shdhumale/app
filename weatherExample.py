...
if root_agent_var_name in globals() and globals()[root_agent_var_name]:
    ...
    # METHOD 1: Direct await (Default for Notebooks/Async REPLs) - REMOVED AS PER INSTRUCTION
    # print("Attempting execution using 'await' (default for notebooks)...")
    # await run_team_conversation()

    # METHOD 2: asyncio.run (For Standard Python Scripts [.py]) - UNCOMMENTED AND ACTIVATED
